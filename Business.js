...
category:PropTypes.string
  ...
  async componentDidMount() {
    console.log("render")
    let url = `https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=51b657d64c4f4b7a9632a19f75e19e8c&pageSize=${this.props.pageSize}`
    ...
    return (
      <>
        ...
        <div className="row">
          ...
          loader={<Spinerr/>}
        > 
          <h1 className='text-center'>   NEWS APP- Top Headlines of Business</h1>
